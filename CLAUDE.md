...
Stdio-based MCP servers (likec4, stitch, signoz, playwright, pencil) can become orphans when a Claude session restarts or crashes. Two mechanisms prevent accumulation:
