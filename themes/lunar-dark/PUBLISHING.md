...
```bash
cd /workspaces/Coder-Workspaces/themes/lunar-dark
npx ovsx publish /workspaces/Coder-Workspaces/shared-assets/vscode-themes/lunar-dark-0.0.1.vsix -p "$OVSX_PAT"
```
